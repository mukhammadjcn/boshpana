...
import { useIsTelegramMobile } from "@/lib/use-is-telegram-mobile";
...
export function BunkerCreatePage() {
  ...
  // Inside the Telegram mini-app the native back button + top branding cover
  // navigation and context, so the in-page header is redundant. A regular
  // browser keeps it.
  const isTgMobile = useIsTelegramMobile();

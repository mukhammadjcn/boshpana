      ...
      <div className="mx-auto flex min-h-screen w-full max-w-2xl flex-col px-5 pt-safe sm:px-6 lg:px-8">
        ...
        <section className="mt-2 flex-1 pb-10">
          ...
          <button
            ...
            disabled={!role}
            className="relative mt-6 flex aspect-[3/4] w-full max-w-sm self-center overflow-hidden rounded-3xl border border-line-strong bg-bg-surface shadow-pop disabled:opacity-60"

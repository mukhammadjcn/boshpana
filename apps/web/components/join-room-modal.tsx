...
import { ActiveRoomConflictModal } from "@/components/games/shared/active-room-conflict-modal";
import {
  parseActiveRoomConflict,
  type ActiveRoomSummary,
} from "@/components/games/shared/online-room-utils";
...
export function JoinRoomModal({
  ...
  async function submitJoin(confirmLeaveExisting = false) {
    setJoinLoading(true);
    setError(null);

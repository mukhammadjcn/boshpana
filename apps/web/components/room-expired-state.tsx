      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-md items-center">
        <section className="w-full rounded-[28px] border border-line-subtle bg-bg-surface p-5 shadow-card">
          ...
          <h1 className="mt-2 text-2xl font-bold leading-tight">
            Bu xonada o'yin tugagan
          </h1>
          <p className="mt-3 text-sm leading-7 text-ink-secondary">
            Xona allaqachon yakunlangan yoki tizimdan o'chirilgan. Bosh
            sahifaga qaytishingiz yoki yangi xona kodini kiritib boshqa
            o'yinga qo'shilishingiz mumkin.
          </p>

          <div className="mt-5 rounded-2xl border border-line-subtle bg-bg-base p-4">
            <p className="text-xs text-ink-muted">Eski xona kodi</p>
